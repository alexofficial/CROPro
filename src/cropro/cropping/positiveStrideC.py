                    ...
                    for sj in range(1, int(nr_stride_steps_j) + 1):
                        ...
                        if cropped_tumour_area_voxel_size >= self.minimum_newthresh_number_of_voxel:
                            ...
                            cv2.rectangle(
                                ...
                                (y_Cord, x_Cord),
                                (
                                    y_Cord + self.arg.crop_image_size,
                                    x_Cord + self.arg.crop_image_size,
                                ),
                                (255, 255, 255),
                                2,
                            )
                            ...
                            if not sub_crop_tmp_img.size == 0:
                                if self.arg.sequence_type == "T2W":
                                    ...
                                    sub_crop_tmp_img_adc = crop_tmp_img_adc[
                                        x1_seg:x2_seg, y1_seg:y2_seg
                                    ]
                                    sub_crop_tmp_img_hbv = crop_tmp_img_hbv[
                                        x1_seg:x2_seg, y1_seg:y2_seg
                                    ]
                                    ...
                                    saveFilesC.save_image_types(
                                        ...
                                        final_y1,
                                        sub_crop_tmp_img,
                                        sub_crop_tmp_img_adc,
                                        sub_crop_tmp_img_hbv,
                                        count=count,
                                    )
